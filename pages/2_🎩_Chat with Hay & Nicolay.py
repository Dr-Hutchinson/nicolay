                ...
                if speech:
                    ...
                    with st.expander(expander_label, expanded=False):
                        ...
                        if key_quote in speech['full_text']:
                            ...
                            formatted_full_text = highlight_key_quote(speech['fullThe error occurs because the `highlight_key_quote` function is not defined in the script. To resolve this, you need to define the function that will use regex to highlight the key quotes within the text. Here's the updated code with the `highlight_key_quote` function included:

### Updated Code with `highlight_key_quote` Function:
